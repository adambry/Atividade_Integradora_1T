...
dados <- read.csv(csv_url, show_col_types = FALSE) %>% 
...
```{r}
modelo_stepAIC <- stepAIC(log, direction = "forward")
...
- A importância das variáveis preditoras em cada modelo variou: enquanto nos modelos de regressão logística e de regularização os peso das variáveis categóricas foi relevantes, nos modelos de floresta e boosting as variáveis númericas  
